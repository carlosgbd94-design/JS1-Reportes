...
async function loadHomeLogos() {
  ...
  if ($("btnSaveSR")) $("btnSaveSR").onclick = async () => {
    ...
    try {
      ...
      const bcg = $("bcg") ? $("bcg").value : "";
      const hepatitis_b = $("hepatitis_b") ? $("hepatitis_b").value : "";
      const hexavalente = $("hexavalente") ? $("hexavalente").value : "";
      const dpt = $("dpt") ? $("dpt").value : "";
      const rotavirus = $("rotavirus") ? $("rotavirus").value : "";
      const neumococica_13 = $("neumococica_13") ? $("neumococica_13").value : "";
      const neumococica_20 = $("neumococica_20") ? $("neumococica_20").value : "";
      const srp = $("srp") ? $("srp").value : "";
      const sr = $("sr") ? $("sr").value : "";
      const vph = $("vph") ? $("vph").value : "";
      const varicela = $("varicela") ? $("varicela").value : "";
      const hepatitis_a = $("hepatitis_a") ? $("hepatitis_a").value : "";
      const td = $("td") ? $("td").value : "";
      const tdpa = $("tdpa") ? $("tdpa").value : "";
      const covid_19 = $("covid_19") ? $("covid_19").value : "";
      const influenza = $("influenza") ? $("influenza").value : "";
      const vsr = $("vsr") ? $("vsr").value : "";
      ...
      for (const f of fields) {
        const val = $(f)?.value;
        if (val !== "" && Number(val) < 0) {
          showToast(`El valor de ${f.toUpperCase()} no puede ser negativo`, false, "warn");
          flashElement(f);
          return;
        }
      }
      ...
      if (EDIT_SR && !hasExistenciaNumericChanges()) {
        showToast("No hiciste cambios en los valores numéricos de la existencia de biológicos", false, "warn");
        return;
      }
